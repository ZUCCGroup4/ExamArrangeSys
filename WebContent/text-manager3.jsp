		...
		<div class="templatemo-sidebar">
			...
			<nav class="templatemo-left-nav">
				<ul>
					...
					<li><a href="selectionjoin" class="active"><i
							class="fa fa-bar-chart fa-fw"></i>考试安排</a></li>
		...
		<div class="templatemo-content col-1 light-gray-bg">
				...
				<div class="row">
					<nav class="templatemo-top-nav col-lg-12 col-md-12">
						<ul class="text-uppercase">
							<li><a href="text-manager1-2.jsp" class="active">第一步
									考试时间安排</a></li>
							<li><a href="text-manager2.jsp" class="active">第二步
									考试地点安排 </a></li>
			...
			<div class="templatemo-content-container">
				<div class="templatemo-content-widget white-bg">
					...
					%>
					<h2 class="margin-bottom-10" style="text-align: center;"><%=year%>学年
						第<%=term%>学期
					</h2>
				...
				<form action="search" class="templatemo-login-form">
					<div class="templatemo-content-widget white-bg">
						<div id="search"
							style="height: 35px; width: 70%; display: inline-block">
				...
				<form action="text-manager-finally.jsp"
						...
						<div
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered">
									...
									<tbody>
										<%
											ArrayList<ArrayList<TestCheckBean>> objlist = (ArrayList<ArrayList<TestCheckBean>>) request
