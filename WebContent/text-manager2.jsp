        ...
        <script >
        	function searchbtn(){
                ...
                if(ipt=="date"){
                    ...
                    btn.href = "selectdate?pagename=text-manager2.jsp&date1="+searchdate1+"&date2="+searchdate2;
                }
                else if(ipt=="name"){
                	claname = $("#claname").val();
                    btn.href = "selectname?pagename=text-manager2.jsp&claname="+claname;
                }
                else if(ipt=="ID"){
                	claid=$("#claid").val();
                    btn.href = "selectid?pagename=text-manager2.jsp&claid="+claid;
                }
        	}
        </script>
          <div class="templatemo-content-widget white-bg">
    ...
    <script type="text/javascript">
	 ...
	 <script type="text/javascript">
       ...
       if(objlist==null||objlist.size()==0){
    	   objlist = (ArrayList<ArrayList<TestCheckBean>>) session.getAttribute("examlist2");
       }
      		 for(int i=0;i<objlist.size();i++) {
