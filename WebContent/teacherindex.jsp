    ...
    <div class="templatemo-content col-1 light-gray-bg">
      ...
      <div class="templatemo-content-container">
        <div class="templatemo-content-widget white-bg">
          <h2 class="margin-bottom-10" style="text-align: center;">教师考试周安排信息</h2>
          <h3 class="margin-bottom-10" style="text-align: center;">监考安排结果</h3>
        </div>
        <!-- <script>
        ...
        <!--<form action="text-manager4.html" class="templatemo-login-form">-->
            ...
            <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <%
                    	List objlist=(List) session.getAttribute("jklist");
	                    	if(objlist!=null){
					          for(int i=0;i<objlist.size();i++){
					        	  ViewCheckBean list=(ViewCheckBean) objlist.get(i);
                    %>
                    <tr>
                    			<td><%=list.getYear()%>-<%=list.getTerm()%></td>
          ...
          <h3 class="margin-bottom-10" style="text-align: center;">主考安排结果</h3>
        </div>
        <div class="col-1">
            <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <%
                    	List zklist=(List) session.getAttribute("zklist");
	                    	if(zklist!=null){
					          for(int i=0;i<zklist.size();i++){
					        	  ViewCheckBean myzklist=(ViewCheckBean) zklist.get(i);
                    %>
                    <tr>
                    			<td><%=myzklist.getYear()%>-<%=myzklist.getTerm()%></td>
								<td><%=myzklist.getCheck_time()%></td>
								<td><%=myzklist.getCourse_id()%></td>
								<td><%=myzklist.getCourse_name()%></td>
								<td><%=myzklist.getCheck_place()%></td>
							</tr>
							<% 
										}
							    }
